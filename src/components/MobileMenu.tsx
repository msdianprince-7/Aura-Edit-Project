    ...
    <div className="md:hidden">
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          ...
          <MobileNavLink href="/explore" onClick={() => setOpen(false)} icon={
          ...
          <MobileNavLink href="/search" onClick={() => setOpen(false)} icon={
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
          }>
            Search
          </MobileNavLink>
          ...
          {isSignedIn ? (
            <>
              <MobileNavLink href="/feed" onClick={() => setOpen(false)} icon={
              ...
              <MobileNavLink href="/settings" onClick={() => setOpen(false)} icon={
