  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <div className="pt-4 flex gap-4">
        <Link 
          href="/upload" 
          className="bg-white text-black px-8 py-3 rounded-full font-semibold hover:scale-105 transition-transform duration-300"
        >
          Start Creating
        </Link>
        <Link 
          href="/dashboard" 
          className="bg-zinc-800 text-white px-8 py-3 rounded-full font-semibold hover:bg-zinc-700 transition-colors duration-300"
        >
          View Dashboard
        </Link>
      </div>
